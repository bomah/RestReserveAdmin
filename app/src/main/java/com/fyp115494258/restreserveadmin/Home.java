                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    newRestaurant = new Restaurant(edtName.getText().toString(),edtLocation.getText().toString(),edtDescription.getText().toString(),edtPhoneNumber.getText().toString(), uri.toString(), edtAdminPhoneNumber.getText().toString());
